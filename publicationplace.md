 ...
 * 2611 [publication places](output.tables/publication_place_accepted.csv); available for 366521 documents (98%). 
 * 38 [publication countries](output.tables/country_accepted.csv); available for 336902 documents (91%).
