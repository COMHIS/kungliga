...
## Page counts
  ...
  * Page count available for 371999 documents in total (100%), including both readily available and estimated page counts.

  * Page count readily available for 237075 documents (63.7%). 

  * Page count estimated for 134924 documents (36.3%).

  * Page count missing and could not be estimated for 137 documents (0%).

  * Page count updated for 2283 documents in the validation phase.
...
Left: Gatherings vs. overall pagecounts (original + estimated). Right: Only the estimated page counts (for the 134924 documents that have missing pagecount info in the original data):
...
Note: there are 299831 documents that have some dimension info but sheet area information could not be calculated. 
