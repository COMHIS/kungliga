...
## Document size comparisons
  ...
  * Some dimension info is provided in the original raw data for altogether 3102 documents (81.6%) but could not be interpreted for 2 documents (ie. dimension info was successfully estimated for 99.9 % of the documents where this field was not empty).

  * Document size (area) info was obtained in the final preprocessed data for altogether 3098 documents (82%). For the remaining documents, critical dimension information was not available or could not be interpreted: [List of entries where document surface could not be estimated](output.tables/physical_dimension_incomplete.csv)

  * Document gatherings info is originally available for 3100 documents (82%), and further estimated up to 3100 documents (82%) in the final preprocessed data.

  * Document height info is originally available for 1 documents (0%), and further estimated up to 3098 documents (82%) in the final preprocessed data.

  * Document width info is originally available for 0 documents (0%), and further estimated up to 3098 documents (82%) in the final preprocessed data.
