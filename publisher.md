 ...
 * 17052 [unique publishers](output.tables/publisher_accepted.csv)

 * 167216 documents have unambiguous publisher information (43.3%). This includes documents identified as self-published; the author name is used as the publisher in those cases (if known).
