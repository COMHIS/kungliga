 ...
 * 2634 [publication places](output.tables/publication_place_accepted.csv); available for 369108 documents (96%). 
 * 39 [publication countries](output.tables/country_accepted.csv); available for 362971 documents (94%).
