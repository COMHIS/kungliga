 ...
 * 8993 documents (12.3%) with a male author
 
 * 250 documents (0.3%) with a female author
 
 * 63933 documents (87.4%) with [unresolved gender](output.tables/author_gender_discarded.csv) (including pseudonymes)
